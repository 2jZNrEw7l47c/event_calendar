"""Quartyard (downtown outdoor venue) — Casbah Presents lists its shows;
...
def scrape(today=None):
    return scrape_casbah.scrape_for_venue("quartyard", "Quartyard", "quartyard", today)


if __name__ == "__main__":
    evs = scrape()
    print("Quartyard: %d events" % len(evs))
    for e in evs[:8]:
